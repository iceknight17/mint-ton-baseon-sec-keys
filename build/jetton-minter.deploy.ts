...
const jettonParams = {
  owner: Address.parse("UQCk2B9nBWGGP-6Mo21VOhcIA5nzIb6PwNLDYJk6iG-kL2oJ"),
  name: "Atos Jetton",
  symbol: "AJT",
  image: "https://bitcoincash-example.github.io/website/logo.png", // Image url
  description: "Atos Jetton Token For Test",
};
